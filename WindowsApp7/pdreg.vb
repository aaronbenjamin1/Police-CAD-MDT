...
Public Class pdreg
    ...
    Private Sub Button2_Click(sender As Object, e As EventArgs) Handles Button2.Click
        ...
        Try
            MySqlConn.Open()
            Dim Query As String
            Query = "insert into database.table1 (badgeno,password) values ('" & TextBox1.Text & "','" & TextBox2.Text & "')"
    ...
    Private Sub pdreg_Load(sender As Object, e As EventArgs) Handles MyBase.Load
